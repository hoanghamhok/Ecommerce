...
namespace EcommerceBackend.Migrations
{
    ...
    [Migration("20251126054610_userandordershipping")]
    partial class userandordershipping
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Models.ProductAnalytics", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("Models.ProductRating", b =>
                {
                    b.HasOne("Models.Product", "Product")
                        .WithOne()
                        .HasForeignKey("Models.ProductRating", "ProductId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
